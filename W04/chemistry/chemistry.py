# Excceeded requirements by adding a dictionary of known chemical formulas
# and a function to look up and display the name of a compound.
...
def main():
    ...
    # Print formula name.
    print(f"{compound_name} compound")
