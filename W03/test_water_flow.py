...
def test_kpa_to_psi():
    assert kpa_to_psi(0.00) == approx(0.000, abs=0.001)
    assert kpa_to_psi(1.00) == approx(0.145, abs=0.001)
    assert kpa_to_psi(100.00) == approx(14.504, abs=0.001)
    assert kpa_to_psi(250.00) == approx(36.260, abs=0.001)
